...
/**
 * Block that continue down the explosion
 */
public class ExplosionContinueDown extends Explosion{
    private static List<ImageIcon> images;

    /**
     * Load Explosion Continue down images
     */
    public static void setImages() throws ImageNotFoundException {

        images = Explosion.setContinueImages("Down");
    }

    /**
     * Constructor of class ExplosionContinueDown
     */
    public ExplosionContinueDown() {
